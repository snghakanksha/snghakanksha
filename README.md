...
works, not just to add it to a resume.
...
- 3-layer medallion architecture across 3 Snowflake databases
- Python ingestion using PUT + COPY INTO (switched from row-by-row
  inserts after they kept timing out at 200k records)
- RFM customer segmentation scoring 9,194 customers using
  NTILE window functions
- Statistical anomaly detection on daily revenue using
  Z-score and IQR methods
- Automated daily refresh via Snowflake Tasks

**Stack:** Snowflake · Python · SQL · Snowflake Tasks

🔗 [View Project](https://github.com/snghakanksha/retail-intelligence-platform)
...
Looking for entry-level Data Analyst roles where I can
contribute from day one and keep learning.
...
[GitHub](https://github.com/snghakanksha)
